...
def load_mlflow_model():
    try:
        ...
        MODEL_NAME = "rf_champion_mobile"
        MODEL_ALIAS = "champion_mobile"
...
def main():
    ...
    if uploaded_file is not None:
        try:
            ...
            st.subheader("Klāšu sadalījums")
            img = mpimg.imread('artifacts/data_price_range_distribution.png')
            ...
            # 4. Load the Model
            st.subheader("4. Mobilo telefonu cenu klases prognozēšana")
            ...
            if model is not None:
                ...
                results_df = pd.DataFrame({
                    "Record Index": data_df.price_range,
            ...
            st.markdown("**Darba procesā tika secināts, ka datu kopai “Mobilo telefonu cenu kategorijas” vispiemērotākais modelis ir “Loģistiskā regresija”.**")
                
            st.subheader("6. Testu datu kopas pārpratumu matrica")
            img = mpimg.imread('artifacts/CM_LogisticRegression.png')
            st.image(img, use_container_width=True) 
